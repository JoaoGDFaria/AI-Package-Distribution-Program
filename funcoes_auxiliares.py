...
def estudoDeUmaEntrega(pontoslevantamento, lista_encomenda, gl, g, ag):
    ...
    for i in range(5):
        ...
        for enc in lista_encomenda:
            enc[0].criarEncomenda(peso=enc[1], preco=enc[2], volume=enc[3], tempoInicio=enc[5], tempoFim=enc[4],
