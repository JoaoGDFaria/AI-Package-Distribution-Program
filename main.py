...
enc1 = cliente2.criarEncomenda(peso=24.23, precoBase=54.23, tempoInicio=datetimeStart, tempoFim=datetime(year=2023, month=11, day=22, hour=22, minute=30))
enc2 = cliente1.criarEncomenda(peso=2423, precoBase=543, tempoInicio=datetimeStart, tempoFim=datetime(year=2023, month=11, day=22, hour=22, minute=30))


list = []
list.append(enc1)
list.append(enc2)
ent = Entrega(list, estafeta1, g, False, datetimeStart, ["PontoRecolhaA", "PontoRecolhaB"])
